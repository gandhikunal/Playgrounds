...
class LinkedList <T: Equatable> {
    ...
    func read(position: Int) {
        ...
        if isEmpty {
            ...
            print("Value at previous node \(position): \(currentNode!.previous?.data)")
            print("Value at next node \(position): \(currentNode!.next?.data)")
...
////// Adding at the head
list.addNode(value: "First Node", addAtHead: false)
...
//list.printAll()
////
//list.modifyNode(data: "Second Node", position: 7)
//list.printAll()
////
//list.read(position: 8)
list.reverseListRecursion(node:list.head!)
list.printAll()
list.read(position: 6)
...
//listEmployee.removeNode(position: 17
////listEmployee.printAll()
